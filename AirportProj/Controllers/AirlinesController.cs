...
namespace AirportProj.Controllers
{
    public class AirlinesController : Controller
    {
        ...
        public AirlinesController(AerportContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AirlineId,Name,IataCode,IcaoCode")] Airline airline)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AirlineId,Name,IataCode,IcaoCode")] Airline airline)
        {

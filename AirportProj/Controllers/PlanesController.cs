...
namespace AirportProj.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public PlanesController(AerportContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PlaneId,MaxDistance,Speed,FirstClass,BusinessClass,EconomyClass,SerialNum")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaneId,MaxDistance,Speed,FirstClass,BusinessClass,EconomyClass,SerialNum")] Plane plane)
        {
            if (id != plane.PlaneId)
            {
                return NotFound();
